...
console.log("Customer hase placed an order:",hasplacedOrder)
...
console.log("Amount of money in a customer's bank account:",bankAccountBalance)
...
console.log("Person's marital status: ",status)
...
console.log("Number of employees in a company:",bookTitle)
...
let event: string="2:30 PM"
console.log("Name of a country:",event)
